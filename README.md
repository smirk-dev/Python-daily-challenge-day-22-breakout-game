...
A modern, minimalistic **Breakout Game** built using **Python** and **Pygame**. Featuring interactive menus, high score tracking, multiple levels, and smooth paddle-ball mechanics, this game brings the arcade classic to life with a polished design.

## 🎮 Features

- **Smooth paddle and ball mechanics**
- **Dynamic level progression** (ball speeds up after each level)
- **High score tracking** (saves top 5 scores)
- **Interactive menu system** (Play, View High Scores, Quit)
- **Randomized brick colors** for visual appeal
- **Polished UI with modern aesthetics**

## 🖥️ How to Play

1. Start the game and select **"Play"** from the menu.
2. Move the paddle using **Left ⬅️** and **Right ➡️** arrow keys.
3. Hit the ball with the paddle to **break all the bricks**.
4. Clear all bricks to advance to the **next level** (ball speed increases).
5. The game ends when the **ball touches the bottom**.
